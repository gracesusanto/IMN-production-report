...
Mesin = sqlalchemy_to_pydantic(
    models.Mesin, exclude=["id", "time_created", "time_updated"]
)

Tooling = sqlalchemy_to_pydantic(
    models.Tooling, exclude=["id", "time_created", "time_updated"]
)

Operator = sqlalchemy_to_pydantic(
    models.Operator, exclude=["id", "time_created", "time_updated"]
)
